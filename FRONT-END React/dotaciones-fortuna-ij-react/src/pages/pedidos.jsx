...
function Pedidos() {
    ...
    useEffect(() => {
        ...
        const pedidosCliente = pedidosGuardados.filter(
    ...
    function obtenerNombreProducto(item) {
        return item?.producto?.nombre || item?.nombre || "Producto";
    }
        ...
        <div className="client-page page-animated">
            <header className="client-navbar animate-slide-down">
                ...
                >
                    ...
                    <div>
                        <strong>Dotaciones Fortuna IJ</strong>
                ...
                <section className="orders-panel animate-fade-in">
                    <div className="orders-panel-header">
                        <div className="animate-slide-left">
                            ...
                            <p>
                                Revisa todos los pedidos realizados desde tu
                                cuenta.
                            </p>
                        </div>
                    ...
                    {pedidosFiltrados.length === 0 ? (
                        ...
                        <div className="orders-list stagger">
                            {pedidosFiltrados.map((pedido) => {
                                const pasoActual =
                                    obtenerPasoEstado(pedido.estado);
            ...
            <footer className="client-footer animate-fade-in">
                ...
                <span>© 2026 Dotaciones Fortuna IJ</span>
            </footer>
        </div>
    );
}
